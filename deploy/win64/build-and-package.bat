...
signtool sign /v /n /a "%NAME%" /t http://time.certum.pl /fd sha1 build_win32\release\*.exe build_win64\release\*.dll
)
...
signtool sign /v /n /a "%NAME%" /t http://time.certum.pl /fd sha1 tony.msi
